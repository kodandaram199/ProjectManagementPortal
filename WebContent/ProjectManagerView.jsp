...
<script>
function pro(){
		var proid= document.getElementById('manager').value;
		...
		xmlhttp.open('GET', 'promanager.jsp?id='+proid, true); 
		xmlhttp.send();
	}
</script>
</head>
...
if(session.getAttribute("usr_name")==null){
 ...
 <jsp:include page="navigation.jsp"></jsp:include>
		...
		<select class="form-control" name="client" id="manager" onchange="pro()">
		<option>Select ProjectManager</option>
			...
			PreparedStatement st = con.prepareStatement("select userid,username from tbl_users where roleid=2");
