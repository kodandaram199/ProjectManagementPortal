...
<script>
function pro(){
		var proid= document.getElementById('employee').value;
		...
		xmlhttp.open('GET', 'empview.jsp?id='+proid, true); 
		xmlhttp.send();
	}
</script>
</head>
...
if(session.getAttribute("usr_name")==null){
 ...
 <jsp:include page="navigation.jsp"></jsp:include>
		...
		<select class="form-control" id="employee" onchange="pro()">
		<option>Select Employee</option>
			<%
			Class.forName("com.mysql.jdbc.Driver");
			Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3309/internship", "root", "pdr16418@@@###");
			PreparedStatement st = con.prepareStatement("select userid,username from tbl_users where roleid=3 or roleid=2");
