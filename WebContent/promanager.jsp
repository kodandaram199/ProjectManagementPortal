...
<div class="jumbotron">
			...
			PreparedStatement st1 = con1.prepareStatement("SELECT u.fullname from tbl_projectdetails p,tbl_users u where p.mgrid=u.userid and p.mgrid="+a);			
			ResultSet rs1=st1.executeQuery();
			if(rs1.next())
			{
			out.println("<h1 style='text-align:center'>Project Details Of ProjectManager "+rs1.getString("fullname"));
			}
			else
			{
			    PreparedStatement st2 = con1.prepareStatement("SELECT fullname from tbl_users where userid="+a);			
				ResultSet rs2=st2.executeQuery();
				while(rs2.next())
				{
			    out.println("<h1 style='text-align:center'>No Projects were under ProjectManager "+rs2.getString("fullname"));
				}
			}
			%>
        	</div>
