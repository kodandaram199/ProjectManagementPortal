...
<script>
function pro(){
		var proid= document.getElementById('client').value;
		...
		xmlhttp.open('GET', 'clientview.jsp?id='+proid, true); 
		xmlhttp.send();
	}
</script>
</head>
...
<jsp:include page="navigation.jsp"></jsp:include>
		...
		<select class="form-control" name="client" id="client" onchange="pro()">
		<option>Select Client</option>
			<%
			Class.forName("com.mysql.jdbc.Driver");
			Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3309/internship", "root", "pdr16418@@@###");
			PreparedStatement st = con.prepareStatement("select clientid,clientname from tbl_clients");
        	...
        	<div id="display">
        	<div class="jumbotron">
        		<h4 style="text-align:center">Recent Added Project</h4>
        	</div>
        	<div>
