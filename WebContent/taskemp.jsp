...
<div class="jumbotron">
			...
			PreparedStatement st1 = con1.prepareStatement("SELECT u.fullname from tbl_tasks t,tbl_users u where t.employeeid=u.userid and t.employeeid="+a);			
			ResultSet rs1=st1.executeQuery();
			if(rs1.next())
			{
			out.println("<h1 style='text-align:center'>Task Details Of Developer "+rs1.getString("fullname"));
			}
			else
			{
				...
				while(rs2.next())
				{
			    out.println("<h1 style='text-align:center'>No Taskss were under Developer "+rs2.getString("fullname"));
				}
			}
			%>
        	</div>
