...
<script>
function pro(){
		var proid= document.getElementById('priority').value;
		...
		xmlhttp.open('GET', 'taskpriority.jsp?id='+proid, true); 
		xmlhttp.send();
	}
</script>
</head>
...
if(session.getAttribute("usr_name")==null){
 ...
 <jsp:include page="navigation.jsp"></jsp:include>
		...
		<select class="form-control" id="priority" onchange="pro()">
		<option>Select Priority</option>
			<%
			Class.forName("com.mysql.jdbc.Driver");
			Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3309/internship", "root", "pdr16418@@@###");
			PreparedStatement st = con.prepareStatement("select priorityid,priority from tbl_priority");
