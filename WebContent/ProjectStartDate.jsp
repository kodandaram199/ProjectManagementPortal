...
<script>
function pro(){
		var proid= document.getElementById('startdate').value;
		...
		xmlhttp.open('GET', 'prostartdate.jsp?id='+proid, true); 
		xmlhttp.send();
	}
</script>
</head>
...
<jsp:include page="navigation.jsp"></jsp:include>
		...
		<select class="form-control" id="startdate" onchange="pro()">
		<option>Select Start Date</option>
			...
			PreparedStatement st = con.prepareStatement("select distinct(startdate) from tbl_projectdetails");
			ResultSet rs=st.executeQuery();
			while(rs.next())
			{
				out.println("<option>"+rs.getString("startdate")+"</option>");
			}
			%>
		</select>
	</div>
